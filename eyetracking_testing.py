...
"""def calculate_calibration():
    left_eye = (left_calibration[-1][0] + left_calibration[-1][1]) / 2
    right_eye = (right_calibration[-1][0] + right_calibration[-1][1]) / 2
...
while True:
    ...
    if not calibrating and len(left_calibration) == 0:
        ...
        pyautogui.moveTo(u * screen_width, v * screen_height)
